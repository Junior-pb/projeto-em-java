...
public class Listaencadeada {
    ...
    public void Iniciar(Scanner sc) {
    	System.out.println("• LISTA ENCADEADA Pode ser infinita se tiver paciência •");
    ...
    public void RemoverElemento(Scanner sc){
        ...
        if(posicao > qtdAlunos || posicao < 1){
        	System.out.println("=> Só temos "+qtdAlunos+" posições até o momento. Escolha um numero de 1 a "+qtdAlunos);
        } else {
            ...
            for(int i=0; i<posicao; i++){                
                ...
                if(i < posicao - 1){
                    ...
                    System.out.println("=> "+(posicao)+" " + aux.getNome() + " REMOVIDO DA LISTA!");
    ...
    public void ExibirElementos(){
        ...
        for(int i=0; i<qtdAlunos; i++){
        	...
        	System.out.println("=> "+(i+1)+" " + aux.getNome());
